...
<html>
    <head>
        ...
        <title>berkeleyhomes homes</title>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  ...
			  <ul class="nav navbar-nav main-menu pull-right">
				...
				<li class="dropdown">
					...
					<span class="caret"></span></a>
					<ul class="dropdown-menu">
					  <li><a href="structural-features.php">Structural Features</a></li>
					  <li><a href="common-area-finishing.php">Common Area Finishing</a></li>
					  <li><a href="typical-appanrtment-features.php">Typical Apartment Feature</a></li>
					</ul>
				</li>
				<li class="dropdown">
  					...
  					<span class="caret"></span></a>
  					<ul class="dropdown-menu">
  					  <li><a href="bank-loan.php">Bank Loan</a></li>
  					  <li><a href="legal-service.php">Legal Service</a></li>
